                    ...
                    subtitle: Column(
                      ...
                      children: <Widget>[
                        notification.filter == 'like'
                            ? Text(
                            '${notification.user.name} liked ${notification
                                .params.title != null &&
                                notification.params.title.toString( ) !=
                                    'false' &&
                                notification.params.title.toString( ) != ''
                            ...
                            ? Text(
                            '${notification.user.name} down voted ${notification
                                .params.title != null &&
                                notification.params.title.toString( ) !=
                                    'false' &&
                                notification.params.title.toString( ) != ''
                            ...
                            ? Text(
                            '${notification.user
                                .name} requested to join ${notification
                                .description != null ? notification.entityObj
                                .name : ""}' )
                            : notification.filter ==
                            'group_invite'
                            ? Text(
                            '${notification.user
                                .name} invited you to join ${notification
                                .entityObj != null
                            ...
                            ? Text(
                            '${notification.user
                                .name} kicked you out of ${notification
                                .entityObj != null
                                ? notification.entityObj.name
                                : ""}' )
                            : notification
                            ...
                            ? Text(
                            '${notification.user
                                .name} approved to add you to the queue' )
                            : notification.filter ==
                            'group_queue_reject'
                            ? Text(
                            '${notification.user
                                .name} rejected your request to add you to the queue' )
                            : notification.filter ==
                            'create_admin_group'
                            ? Text(
                            ...
                            .name} rejected your request to join the group' )
                            : notification.filter == 'wire_happened' ? Text(
                            'you have succesfully contributed ${notification
                                .params.amount} to @${notification.params
                                .username}' ) : notification.filter == 'remind'
                            ? Text(
                            '${notification.user.name} reposted ${notification
                                .params.title}' )
                            : notification.filter == 'group_join_accept' ? Text(
                            '${notification.user.name} has joined ${notification
                                .entityObj != null
                                ? notification.entityObj.name
                                : ""}' ) : notification.filter == 'boost_accept'
                            ? Text( '${notification.user
                            .name} have accepted the boost' )
                            : notification.filter == 'boost_reject'
                            ? Text( '${notification.user
                            .name} have rejected the boost' )
                            : Container( ),
                      ],
                    ),
                  ),
